    ...
    <div class="mt-lg-5">
        <div class="row" id="body-row">
            ...
            <div class="col-lg-9 ml-lg-5 mt-lg-5 col-2">
                ...
                <div>
                    <form class="form-inline my-2 my-lg-0 mb-lg-3">
                        ...
                        <button class="btn btn-primary ml-1">Tambah</button>
                    </form>
                ...
                <table border="5" cellspacing="5" cellpadding="10">
                    ...
                    <tr>
                        <td>1</td>
                        <td>Hilmanadi Yahya</td>
                        <td>Tanah laut, 7 September 2002</td>
                        <td>Mahasiswa</td>
                        <td>Ubah | Hapus</td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>Nadia Marta Wulan</td>
                        <td>Tanah laut, 15 Maret 2002</td>
                        <td>Mahasiswa</td>
                        <td>Ubah | Hapus</td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>Medya Resti Azkia</td>
                        <td>Tanah laut, 12 Desember 2007</td>
                        <td>Pelajar</td>
                        <td>Ubah | Hapus</td>
                    </tr>
                </table>
