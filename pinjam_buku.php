...
<body>
    ...
    <div class="mt-lg-5">
        <div class="row" id="body-row">
            ...
            <!-- Daftar Anggota -->
            <div class="col-lg-5 ml-lg-5 mt-lg-5 col-2">
                <div class="mb-lg-5">
                    <br>
                    <h3>
                        DATA PEMINJAM BUKU
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="" id="" cols="10" rows="3" type="text" class="form-control" id="formGroupExampleInput"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput4">Pekerjaan</label>
                        <input type="text" class="form-control" id="formGroupExampleInput2">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput5">Buku Yang Di Pinjam</label>
                        <select class="custom-select">
                            <option selected>Pilih</option>
                            <option>Hary Potter (J.K Rowling)</option>
                            <option>Romeo & Juliette (William Shakespeare)</option>
                            <option>Bumi Manusia (Pramoedya Ananta Toer)</option>
                        </select>
                    </div>
                    <a href="laporan_buku.php"><button type="button" class="btn btn-primary">Simpan</button></a>
            </div>
            </form>
            <div>
            </div>
